...
void diagPres() {
    ...
    do {
        ...
        cout << "1. Ingresar diagnóstico" << endl;
        cout << "2. Ingresar prescripción" << endl;
        cout << "3. Mostrar diagnósticos y prescripciones anteriores" << endl;  // Nueva opción
        cout << "Elija una opción: ";
        
        while (!(cin >> opcion) || cin.peek() != '\n' || opcion < 1 || opcion > 3) {
            cout << "Entrada inválida. Por favor, ingrese 1, 2 o 3: ";
            cin.clear();
        ...
        switch (opcion) {
            ...
            case 3: {
                ...
                while (!cedulaValida) {
                    cout << "Ingrese la cédula del paciente para mostrar diagnósticos y prescripciones anteriores: ";
                    cin >> cedula;
