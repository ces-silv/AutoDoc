...
void mamaIzq(UltMamas& UM) {
    ...
    while (tejidoPredominIzq == false) {
        ...
        printf("Escribe las características del tejido mamario predominante (de la mama izquierda)\n");
        getline(cin, UM.tejidoPredominIzq);

        printf("\n\nDescripciones específicas - Cuadrantes en los que está distribuido el tejido\n");
        printf("  - Cuadrante 1\n");
        ...
        printf("\n\n¿Ha ingresado todo correctamente? Si es así, presione S o ingrese cualquier otra letra para ingresarlo nuevamente.\n");
        cin >> opc;
...
void mamaDer(UltMamas& UM) {
    ...
    while (tejidoPredominDer == false) {
        cout << "ULTRASONIDO DE MAMAS\n\n";
        printf("Escribe las características del tejido mamario predominante (de la mama derecha)\n");
...
void lesionMamaIzq(UltMamas& UM) {
    ...
    while (UM.lesionesMamaIzq == false) {
        ...
        printf("Recuerda que en el documento se mostrará de la siguiente manera : A x B x C\n\n");
        cout << "Medida A:" << endl;
        while (!(cin >> UM.xQuisteIzq) || cin.fail()) {
            cin.clear();
            cin.ignore(numeric_limits<streamsize>::max(), '\n');
            printf("ERROR - No ingresaste un número, inténtelo otra vez\n");
            printf("Medida A:\n");
        }
        cout << "Medida B:" << endl;
...
void lesionesMamas(UltMamas& UM) {
    int opc;
    cout << "ULTRASONIDO DE MAMAS\n\n";
    printf("¿Alguna de las mamas tiene lesiones?\n");
    printf("1. Sólo la mama izquierda.\n");
    printf("2. Sólo la mama derecha.\n");
    printf("3. Ambas.\n");
    printf("4. Ninguna.\n");
    cout << " ---> "; cin >> opc;
    ...
    default:
        printf("ERROR - No ingresaste un número válido, inténtelo otra vez\n");
        system("pause || read -p 'Presiona Enter para continuar...' -n 1 -s");
        system("clear || cls");
        lesionesMamas(UM);
        break;
...
void BIRADS(UltMamas& UM) {
    ...
    printf("Escala de 0 a 5. Ingrese el número correspondiente según las normas internacionales.\n");
    cout << " ---> ";
    cin >> UM.BIRADS;
    ...
    {
        system("clear || cls");
        printf("\nERROR - No ingresaste un número dentro del rango solicitado, inténtelo otra vez.\n\n");
        BIRADS(UM);
    }
